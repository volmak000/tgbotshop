...
def payments_settings():
    ...
    kb.append(InlineKeyboardButton("🔸 BTC (Bitcoin)", callback_data="payments:btc"))
    kb.append(InlineKeyboardButton("🔹 ETH", callback_data="payments:ETH"))
    kb.append(InlineKeyboardButton("🔹 USDT (ERC20)", callback_data="payments:USDT_ERC20"))
    kb.append(InlineKeyboardButton("🟠 USDC (ERC20)", callback_data="payments:USDC_ERC20"))
    kb.append(InlineKeyboardButton("🟣 TRX", callback_data="payments:TRX"))
    kb.append(InlineKeyboardButton("🟡 USDT (TRC20)", callback_data="payments:USDT_TRC20"))
    
    kb.append(InlineKeyboardButton("🔸 USDC (TRC20)", callback_data="payments:USDC_TRC20"))
    kb.append(InlineKeyboardButton("🔹 BNB", callback_data="payments:BNB"))
    kb.append(InlineKeyboardButton("🔹 USDT (BEP20)", callback_data="payments:USDT_BEP20"))
    kb.append(InlineKeyboardButton("🟠 BUSD", callback_data="payments:BUSD"))
    kb.append(InlineKeyboardButton("🟣 SOL", callback_data="payments:SOL"))
    kb.append(InlineKeyboardButton("🟡 USDC (SOL)", callback_data="payments:USDC_SOL"))
    kb.append(InlineKeyboardButton("🟠 Litecoin", callback_data="payments:LTC"))
...
def payments_settings_info(way, status):
    ...
    if way in ["btc", "ETH", "USDT_ERC20", "USDC_ERC20", "TRX", "USDT_TRC20", "USDC_TRC20", "BNB", "USDT_BEP20", "BUSD", "SOL", "USDC_SOL", "LTC"]:
        kb.append(InlineKeyboardButton("✏ Изменить адрес", callback_data=f"payments_edit_address:{way}"))   
...
def edit_cat_inl(cat_id):
    ...
    kb.append(InlineKeyboardButton(f"🖼 Изменить фото", callback_data=f"edit_cat_photo:{cat_id}"))
...
def color_keyboard():
    ...
    colors = ["Black", "White", "Red", "Blue", "Green", "Yellow", "Purple", "Pink", "Silver", "Space Gray", "Midnight", "Starlight", "Gold", "Graphite", "Sierra Blue", "Alpine Green", "Deep Purple", "Natural Titanium", "Blue Titanium", "White Titanium", "Black Titanium"]
    for color in colors:
        keyboard.add(InlineKeyboardButton(color, callback_data=f"color_{color}"))
    return keyboard
...
def storage_keyboard():
    ...
    for storage in storages:
        keyboard.add(InlineKeyboardButton(storage, callback_data=f"storage_{storage}"))
    return keyboard
...
def edit_pos_inl(pos_id, has_variants=False):
    keyboard = InlineKeyboardMarkup()
    kb = []
    ...
    kb.append(InlineKeyboardButton("➕ Добавить вариацию", callback_data=f"add_variant:{pos_id}"))
    kb.append(InlineKeyboardButton("✏ Редактировать вариации", callback_data=f"edit_variants:{pos_id}"))
    kb.append(InlineKeyboardButton("👁 Просмотр вариаций", callback_data=f"view_variants:{pos_id}"))
    keyboard.add(kb[0], kb[1])
