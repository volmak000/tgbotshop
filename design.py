...
choose_buy_product = "<b>Подтвердите <code>{name}</code> <code>.</code>?</b>"
choose_buy_products = "<b>Подтвердите <code>{name}</code>  <code>{amount}</code>?</b>"
...
🧾 Check: <code>{receipt}</code>
️💎 Product: <code>{name} | {amount}pcs | {amount_pay}</code>
🎨Color: <code>{color}</code>
💾Memory: <code>{storage}GB</code>
